-- On busy databases, pre-create these indexes CONCURRENTLY before deployment.
-- Normal migration replay then skips them, while fresh installations converge here.
